...
public class AviumMaintainerCardController extends AbstractPreferenceController {

    private static final String UNKNOWN = "Unknown";
    private static final String PROC_VERSION_PATH = "/proc/version";
    private LayoutPreference mLayoutPreference;

    public AviumMaintainerCardController(Context context, String key) {
        super(context);
    }
    ...
    public void updateState(Preference preference) {
        ...
        maintainerView.setText(SystemProperties.get("ro.avium.maintainer", UNKNOWN));
        
        TextView kernelView = mLayoutPreference.findViewById(R.id.kernel_value);
        kernelView.setText(getKernelVersion());

        TextView selinuxView = mLayoutPreference.findViewById(R.id.selinux_status_value);
        selinuxView.setText(getSelinuxStatus());
    }
